...
static_assert(!units_compatible<unit_multiply_t<meter_unit, second_unit>, meter_unit>::value,
    "A unit is not compatible with itself multiplied by something");
static_assert(!units_compatible<unit_divide_t<meter_unit, second_unit>, meter_unit>::value,
    "A unit is not compatible with itself divided by something");
static_assert(!units_compatible<henry_unit, volt_unit>::value, "A unit is not compatible with a completely different unit");